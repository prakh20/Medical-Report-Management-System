  ...
  <div class="parallax foo">
       <?php include 'dnavbar.php';?>
        ...
        <div  style="font-size:50px text-align: center; position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);color: black;">
            ...
            <h1 class="animated rubberBand" >DOCTOR</h1>
            <p>WE ARE FOR YOU!</p>
            
            <?php if(isset($_SESSION['did'])==true)
             { 
            ?>
               <a class="btn btn-success" style="text-align: center" href="dviewpatientdetail.php">VIEW PATIENT DETAILS</a>
            <?php 
             } 
             else
             { 
            ?>
               <a class="btn btn-success" style="text-align: center" href="dlogin.php">Login To View Data</a> 
            <?php 
             } 
            ?>
